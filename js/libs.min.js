function run_validator(a, b) {
    if (a) {
        if (a.length > 512) return error_message = "Stream exceeds maxiumum allowable length of 512.", void(b && b.error ? b.error(error_message) : console.log(error_message));
        b && b.in_progress && b.in_progress(), b && void 0 == b.api_key && console.log("Please pass in api_key to mailgun_validator.");
        var c = !1;
        $.ajax({
            type: "GET",
            ...
            success: function(a, d) {
                c = !0, b && b.success && b.success(a)
            },
            error: function(a, d, e) {
                c = !0, error_message = "Error occurred, unable to validate address.", b && b.error ? b.error(error_message) : console.log(error_message)
            }
        }), setTimeout(function() {
            error_message = "Error occurred, unable to validate address.", c || (b && b.error ? b.error(error_message) : console.log(error_message))
        }, 3e4)
    }
}
...
function loadBlog() {
    $.ajax({
        type: "GET",
        url: "/br/blogumblerfeed",
        dataType: "xml",
        success: function(a) {
            $(a).find("item:first").each(function() {
                var a = $(this).find("title").text(),
                    b = $(this).find("link").text(),
                    c = $(".footer-anchor-link");
                c.attr("href", b), c.text(a), c.next().remove()
            })
        },
        error: function() {
            var a = "//blog.umbler.com/br/empreendedorismo-criativo-e-inovacao-por-que-fazer/",
                b = "Empreendedorismo criativo e inovação: por que fazer?",
                c = $(".footer-anchor-link");
            c.attr("href", a), c.text(b), c.next().remove()
        }
    })
}! function(a) {
    var b = !1;
...
}), $.fn.mailgun_validator = function(a) {
        return this.each(function() {
            $(this).focusout(function() {
                run_validator($(this).val(), a)
            })
        })
    }, ! function(a) {
        function b() {
            a[c].glbl || (h = {
                ...
                return "mm-" + a
            }, e.add("wrapper menu vertical panel nopanel current highest opened subopened navbar hasnavbar title btn prev next first last listview nolistview selected divider spacer hidden fullsubopen"), e.umm = function(a) {
        ...
        if (!a[c]) {
            a[c] = function(a, b, c) {
                ...
                openPanel: function(b) {
                    var c = b.parent();
                    if (c.hasClass(e.vertical)) {
                        var d = c.parents("." + e.subopened);
                        if (d.length) return this.openPanel(d.first());
                        c.addClass(e.opened)
                    } else {
                        if (b.hasClass(e.current)) return;
                        var f = a(this.$menu).children("." + e.panel),
                            g = f.filter("." + e.current);
                        f.removeClass(e.highest).removeClass(e.current).not(b).not(g).not("." + e.vertical).addClass(e.hidden), b.hasClass(e.opened) ? g.addClass(e.highest).removeClass(e.opened).removeClass(e.subopened) : (b.addClass(e.highest), g.addClass(e.subopened)), b.removeClass(e.hidden).addClass(e.current), setTimeout(function() {
                ...
                _initPanels: function(b) {
                    var c = this;
                    this.__findAddBack(b, "ul, ol").not("." + e.nolistview).addClass(e.listview);
                    var d = this.__findAddBack(b, "." + e.listview).children();
                    this.__refactorClass(d, this.conf.classNames.selected, "selected"), this.__refactorClass(d, this.conf.classNames.divider, "divider"), this.__refactorClass(d, this.conf.classNames.spacer, "spacer"), this.__refactorClass(this.__findAddBack(b, "." + this.conf.classNames.panel), this.conf.classNames.panel, "panel");
                    var g = a(),
                        h = b.add(b.find("." + e.panel)).add(this.__findAddBack(b, "." + e.listview).children().children(this.conf.panelNodetype)).not("." + e.nopanel);
                    this.__refactorClass(h, this.conf.classNames.vertical, "vertical"), this.opts.slidingSubmenus || h.addClass(e.vertical), h.each(function() {
                        var b = a(this),
                            d = b;
                        b.is("ul, ol") ? (b.wrap('<div class="' + e.panel + '" />'), d = b.parent()) : d.addClass(e.panel);
                        var f = b.attr("id");
                        b.removeAttr("id"), d.attr("id", f || c.__getUniqueId()), b.hasClass(e.vertical) && (b.removeClass(c.conf.classNames.vertical), d.add(d.parent()).addClass(e.vertical)), g = g.add(d);
                        var h = d.children().first(),
                            i = d.children().last();
                        h.is("." + e.listview) && h.addClass(e.first), i.is("." + e.listview) && i.addClass(e.last)
                    });
                    var i = a("." + e.panel, this.$menu);
                    g.each(function() {
                        var b = a(this),
                            d = b.parent(),
                        ...
                        if (!b.children("." + e.navbar).length && !d.hasClass(e.vertical)) {
                            ...
                            if (d.length) {
                                ...
                                j.append('<a class="' + e.btn + " " + e.prev + '" href="#' + h + '" data-target="#' + h + '"></a>').append('<a class="' + e.title + '"' + (_url ? ' href="' + _url + '"' : "") + ">" + g.text() + "</a>").prependTo(b), b.addClass(e.hasnavbar)
                            } else c.opts.navbar.title && (j.append('<a class="' + e.title + '">' + c.opts.navbar.title + "</a>").prependTo(b), b.addClass(e.hasnavbar))
                        }
                    });
                    var j = this.__findAddBack(b, "." + e.listview).children("." + e.selected).removeClass(e.selected).last().addClass(e.selected);
                    j.add(j.parentsUntil("." + e.menu, "li")).filter("." + e.vertical).addClass(e.opened).end().not("." + e.vertical).each(function() {
                    ...
                    }), j.children("." + e.panel).not("." + e.vertical).addClass(e.opened).parentsUntil("." + e.menu, "." + e.panel).not("." + e.vertical).first().addClass(e.opened).addClass(e.subopened);
                    var k = i.filter("." + e.opened);
                    return k.length || (k = g.first()), k.addClass(e.opened).last().addClass(e.current), g.not("." + e.vertical).not(k.last()).addClass(e.hidden).end().appendTo(this.$menu), g
                },
                _initAnchors: function() {
                    ...
                    h.$body.on(g.click + "-oncanvas", "a[href]", function(d) {
                        ...
                        if (g && d.preventDefault(), !g && i && f.is("." + e.listview + " > li > a") && !f.is('[rel="external"]') && !f.is('[target="_blank"]')) {
                            ...
                            var m = b.__valueOrFn(b.opts.onClick.preventDefault, f, "#" == k.slice(0, 1));
                            m && d.preventDefault(), b.__valueOrFn(b.opts.onClick.blockUI, f, !m) && h.$html.addClass(e.blocking), b.__valueOrFn(b.opts.onClick.close, f, m) && b.close();
                        }
                    })
                },
...
! function(a, b) {
    ...
    var a = function(a) {
        ...
        d = function(a, c, d) {
            return a.setAttribute(b + c, d)
        },
        e = function(a) {
            return a.filter(function(a) {
                return !c(a, "was-processed")
            })
        },
        f = function(a, b) {
            var c, d = "LazyLoad::Initialized",
                e = new a(b);
            try {
                c = new CustomEvent(d, {
                    detail: {
                ...
                c = document.createEvent("CustomEvent"), c.initCustomEvent(d, !1, !1, {
                    instance: e
                })
            }
        ...
        g = function(a, b) {
            if (b.length)
                for (var c, d = 0; c = b[d]; d += 1) f(a, c);
            else f(a, b)
        },
        h = function(a, b) {
            var d = b.data_srcset,
                e = a.parentNode;
            if (e && "PICTURE" === e.tagName)
                for (var f, g = 0; f = e.children[g]; g += 1)
                    if ("SOURCE" === f.tagName) {
                        var h = c(f, d);
                        h && f.setAttribute("srcset", h)
                    }
        },
        i = function(a, b) {
            var d = b.data_src,
            ...
            if ("IMG" === f) {
                h(a, b);
                var i = c(a, e);
                return i && a.setAttribute("srcset", i), void(g && a.setAttribute("src", g))
            }
            return "IFRAME" === f ? void(g && a.setAttribute("src", g)) : void(g && (a.style.backgroundImage = 'url("' + g + '")'))
        },
        j = "undefined" != typeof window,
        k = j && "IntersectionObserver" in window,
        l = j && "classList" in document.createElement("p"),
        m = function(a, b) {
            return l ? void a.classList.add(b) : void(a.className += (a.className ? " " : "") + b)
        },
        n = function(a, b) {
            return l ? void a.classList.remove(b) : void(a.className = a.className.replace(new RegExp("(^|\\s+)" + b + "(\\s+|$)"), " ").replace(/^\s+/, "").replace(/\s+$/, ""))
        },
        o = function(a, b) {
            a && a(b)
        },
        ...
        q = "error",
        r = function(a, b, c) {
            a.removeEventListener(p, b), a.removeEventListener(q, c)
        },
        s = function(a, b) {
            var c = function e(c) {
                    t(c, !0, b), r(a, e, d)
            ...
            a.addEventListener(p, c), a.addEventListener(q, d)
        },
        t = function(a, b, c) {
            var d = a.target;
            n(d, c.class_loading), m(d, b ? c.class_loaded : c.class_error), o(b ? c.callback_load : c.callback_error, d)
        },
        u = function(a, b) {
            o(b.callback_enter, a), ["IMG", "IFRAME"].indexOf(a.tagName) > -1 && (s(a, b), m(a, b.class_loading)), i(a, b), d(a, "was-processed", !0), o(b.callback_set, a)
        },
        v = function(a) {
            return a.isIntersecting || a.intersectionRatio > 0
        },
        w = function(b, c) {
            this._settings = a(b), this._setObserver(), this.update(c)
        };
    w.prototype = {
        _setObserver: function() {
            ...
            if (k) {
                var b = this._settings,
                    c = {
                        root: b.container === document ? null : b.container,
                        rootMargin: b.threshold + "px"
                    },
                    d = function(b) {
                        b.forEach(function(b) {
                            if (v(b)) {
                                var c = b.target;
                                u(c, a._settings), a._observer.unobserve(c)
                            }
                        }), a._elements = e(a._elements)
                    };
                this._observer = new IntersectionObserver(d, c)
            }
        },
        update: function(a) {
            var b = this,
                c = this._settings,
                d = a || c.container.querySelectorAll(c.elements_selector);
            return this._elements = e(Array.prototype.slice.call(d)), this._observer ? void this._elements.forEach(function(a) {
                b._observer.observe(a)
            }) : (this._elements.forEach(function(a) {
                u(a, c)
            }), void(this._elements = e(this._elements)))
        },
        destroy: function() {
            var a = this;
            this._observer && (e(this._elements).forEach(function(b) {
                a._observer.unobserve(b)
            }), this._observer = null), this._elements = null, this._settings = null
        }
    };
    var x = window.lazyLoadOptions;
    return j && x && g(w, x), w
});
var Konami = {};
! function(a, b) {
    var c = a.sequence = function() {
        var a = Array.prototype.slice.call(arguments),
            c = 0;
        return function(d) {
            d = d || b.event, d = d.keyCode || d.which || d, (d === a[c] || d === a[c = 0]) && (d = a[++c], "function" == typeof d && (d(), c = 0))
        }
    };
    a.code = function(a) {
        return c(38, 38, 40, 40, 37, 39, 37, 39, 66, 65, a)
    }
}(Konami, window);
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(a, b, c) {
                ...
                e.version = "1.16.0", j.constructor = e, j.kill()._gc = !1, e.killTweensOf = e.killDelayedCallsTo = c.killTweensOf, e.getTweensOf = c.getTweensOf, e.lagSmoothing = c.lagSmoothing, e.ticker = c.ticker, e.render = c.render, j.invalidate = function() {
                    ...
                    var d, e, h, i, j, l, m, n, o = this._dirty ? this.totalDuration() : this._totalDuration,
                        ...
                        s = this._duration,
                        t = this._rawPrevTime;
                    if (a >= o ? (this._totalTime = o, this._cycle = this._repeat, this._yoyo && 0 !== (1 & this._cycle) ? (this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0) : (this._time = s, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1), this._reversed || (d = !0, e = "onComplete"), 0 === s && (this._initted || !this.vars.lazy || c) && (this._startTime === this._timeline._duration && (a = 0), (0 === a || 0 > t || t === f) && t !== a && (c = !0, t > f && (e = "onReverseComplete")), this._rawPrevTime = n = !b || a || t === a ? a : f)) : 1e-7 > a ? (this._totalTime = this._time = this._cycle = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== q || 0 === s && t > 0) && (e = "onReverseComplete", d = this._reversed), 0 > a && (this._active = !1, 0 === s && (this._initted || !this.vars.lazy || c) && (t >= 0 && (c = !0), this._rawPrevTime = n = !b || a || t === a ? a : f)), this._initted || (c = !0)) : (this._totalTime = this._time = a, 0 !== this._repeat && (i = s + this._repeatDelay, this._cycle = this._totalTime / i >> 0, 0 !== this._cycle && this._cycle === this._totalTime / i && this._cycle--, this._time = this._totalTime - this._cycle * i, this._yoyo && 0 !== (1 & this._cycle) && (this._time = s - this._time), this._time > s ? this._time = s : 0 > this._time && (this._time = 0)), this._easeType ? (j = this._time / s, l = this._easeType, m = this._easePower, (1 === l || 3 === l && j >= .5) && (j = 1 - j), 3 === l && (j *= 2), 1 === m ? j *= j : 2 === m ? j *= j * j : 3 === m ? j *= j * j * j : 4 === m && (j *= j * j * j * j), this.ratio = 1 === l ? 1 - j : 2 === l ? j : .5 > this._time / s ? j / 2 : 1 - j / 2) : this.ratio = this._ease.getRatio(this._time / s)), p === this._time && !c && r === this._cycle) return void(q !== this._totalTime && this._onUpdate && (b || this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || k)));
                    if (!this._initted) {
                ...
                var d = function(a) {
                    ...
                    q = d.prototype = new b;
                return d.version = "1.16.0", q.constructor = d, q.kill()._gc = q._forcingPlayhead = !1, q.to = function(a, b, d, e) {
                    ...
                    var d, f, g, h, i, m = this._dirty ? this.totalDuration() : this._totalDuration,
                        ...
                        p = this._timeScale,
                        q = this._paused;
                    if (a >= m) this._totalTime = this._time = m, this._reversed || this._hasPausedChild() || (f = !0, h = "onComplete", 0 === this._duration && (0 === a || 0 > this._rawPrevTime || this._rawPrevTime === e) && this._rawPrevTime !== a && this._first && (i = !0, this._rawPrevTime > e && (h = "onReverseComplete"))), this._rawPrevTime = this._duration || !b || a || this._rawPrevTime === a ? a : e, a = m + 1e-4;
                    else if (1e-7 > a)
            ...
            function() {
                ...
                j.constructor = g, g.version = "1.16.0", g.API = 2, g.defaultTransformPerspective = 0, g.defaultSkewType = "compensated", j = "px", g.suffixMap = {
                    top: j,
                    right: j,
                    bottom: j,
                    left: j,
                ...
                var ua, va = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                    ...
                    Ga = O.getTransform = function(a, b, c, d) {
                        ...
                        return c && (a._gsTransform = q, q.svg && (ua && a.style[wa] ? La(a.style, wa) : !ua && a.getAttribute("transform") && a.removeAttribute("transform"))), q
                    },
                    Ha = function(a) {
                        var b, c, d = this.data,
                            e = -d.rotation * H,
                    ...
                    Ja = O.set2DTransformRatio = function(a) {
                        var b, c, d, e, f, g, h, i, j, k, l, m, n = this.data,
                            ...
                            q = n.x,
                            r = n.y;
                        return !(n.rotationX || n.rotationY || n.z || n.force3D === !0 || "auto" === n.force3D && 1 !== a && 0 !== a) || n.svg && ua || !za ? (e = n.scaleX, f = n.scaleY, void(n.rotation || n.skewX || n.svg ? (b = n.rotation * H, c = n.skewX * H, d = 1e5, g = Math.cos(b) * e, h = Math.sin(b) * e, i = Math.sin(b - c) * -f, j = Math.cos(b - c) * f, c && "simple" === n.skewType && (m = Math.tan(c), m = Math.sqrt(1 + m * m), i *= m, j *= m), n.svg && (q += n.xOrigin - (n.xOrigin * g + n.yOrigin * i), r += n.yOrigin - (n.xOrigin * h + n.yOrigin * j), l = 1e-6, l > q && q > -l && (q = 0), l > r && r > -l && (r = 0)), k = (0 | g * d) / d + "," + (0 | h * d) / d + "," + (0 | i * d) / d + "," + (0 | j * d) / d + "," + q + "," + r + ")", n.svg && ua ? o.setAttribute("transform", "matrix(" + k) : p[wa] = (n.xPercent || n.yPercent ? "translate(" + n.xPercent + "%," + n.yPercent + "%) matrix(" : "matrix(") + k) : p[wa] = (n.xPercent || n.yPercent ? "translate(" + n.xPercent + "%," + n.yPercent + "%) matrix(" : "matrix(") + e + ",0,0," + f + "," + q + "," + r + ")")) : (this.setRatio = Ia, void Ia.call(this, a))
                    };
                ...
                j = g.prototype, j._firstPT = j._lastParsedTransform = j._transform = null, j._onInitTween = function(a, b, h) {
                    ...
                    if (l && "" === v.zIndex && (i = X(a, "zIndex", e), ("auto" === i || "" === i) && this._addLazySet(v, "zIndex", 0)), "string" == typeof b && (p = v.cssText, i = $(a, e), v.cssText = p + ";" + b, i = _(a, i, $(a)).difs, !Q && w.test(b) && (i.opacity = parseFloat(RegExp.$1)), b = i, v.cssText = p), this._firstPT = j = this.parse(a, b, null), this._transformType) {
                        ...
                        t = new oa(a, "transform", 0, 0, null, 2), this._linkCSSP(t, null, n), t.setRatio = u && za ? Ia : wa ? Ja : Ha, t.data = this._transform || Ga(a, e, !0), t.tween = h, f.pop()
                    }
                    if (c) {
                        for (; j;) {
                ...
                return g.cascadeTo = function(a, c, d) {
                    ...
                    for (a = i._targets || i.target, Pa(a, k, m), i.render(c, !0, !0), Pa(a, l), i.render(0, !0, !0), i._enabled(!0), e = m.length; --e > -1;)
    ...
    function(a, b) {
        ...
        if (!c.TweenLite) {
            ...
            f = F.prototype = new C, f.constructor = F, f.kill()._gc = !1, f.ratio = 0, f._firstPT = f._targets = f._overwrittenProps = f._startAt = null, f._notifyPluginsOfEnabled = f._lazy = !1, F.version = "1.16.0", F.defaultEase = f._ease = new u(null, null, 1, 1), F.defaultOverwrite = "auto", F.ticker = g, F.autoSleep = 120, F.lagSmoothing = function(a, b) {
                g.lagSmoothing(a, b)
        ...
        function a(a, b) {
            a ? b.removeClass("bg-solid").find(".navbar-nav > li > a").end().find(".navbar-brand div").removeClass("logo-umbler").addClass("logo-umbler-negativo") : b.addClass("bg-solid").find(".navbar-nav > li > a").end().find(".navbar-brand div").removeClass("logo-umbler-negativo").addClass("logo-umbler")
        }
        if ($("body").hasClass("is-desktop")) {
            var b = $("body"),
                ...
                d = c.scrollTop(),
                e = !1;
            50 > d && c.removeClass("bg-solid"), b.waypoint(function(b) {
                e || a("up" === b, c)
            }, {
                offset: "-50px"
            });
            ...
            g.mailgun_validator({
                ...
                success: function(a) {
                    var b = g.closest("form").validate();
                    a.did_you_mean ? b.showErrors({
                        email: "Voc&ecirc; quis dizer <em><a href=\"javascript:void(0)\" onclick=\"$('#email').val('" + a.did_you_mean + "').focusout();\">" + a.did_you_mean + "</a> </em>"
                    }) : a.is_valid || b.showErrors({
                        email: "Digite um email v&aacute;lido."
                    })
                },
                error: function() {}
            }), $("body").waypoint(function(a) {
                "down" === a && $("a#back-top").stop(!0, !1).animate({
                    bottom: "90px"
                }, 1500, "easeInOutBack"), "up" === a && $("a#back-top").stop(!0, !1).animate({
                    bottom: "-300px"
                }, 1e3, "easeInBack")
            }, {
                offset: "-150px"
                ...
                match: function() {
                    $(window).scroll(function() {
                        $(window).scrollTop() + $(window).height() == $(document).height() && $(".mascote-coala").css("opacity", 1).addClass("visible animated slideInUp duration-300")
                    })
                }
            }]), $(".js-anchor-section").on("click", function(a) {
                var b = $("#menu").outerHeight() + 50;
                a.preventDefault(), $("html, body").animate({
                    scrollTop: $($(this).attr("href")).offset().top - b
                }, 400, "linear")
            })
        }
        $.get("//static.umbler.com/umbootstrap/assets/svg/sprite-umbler.svg", function(a) {
            var b = document.createElement("div");
            b.setAttribute("class", "hidden-xs-up"), b.innerHTML = (new XMLSerializer).serializeToString(a.documentElement), document.body.insertBefore(b, document.body.childNodes[0])
        }), $.get("//static.umbler.com/umbootstrap/assets/svg/sprite-logos.svg", function(a) {
            var b = document.createElement("div");
            b.setAttribute("class", "hidden-xs-up"), b.innerHTML = (new XMLSerializer).serializeToString(a.documentElement), document.body.insertBefore(b, document.body.childNodes[0])
        }), $("#menu-mobile").mmenu({
            dragOpen: {
            ...
            extensions: ["effect-slide-menu", "effect-slide-panels-0", "pageshadow", "theme-dark"]
        }, {
            transitionDuration: 500
        }), $(".mm-navbar").hide(), $(".mm-menu>.mm-panel.mm-hasnavbar").css("padding-top", "15px"), $("#form-signup-rewards").validate({
            highlight: function(a, b, c) {
                $(a).parents(".form-group").removeClass("has-success").addClass("has-error")
            },
            unhighlight: function(a, b, c) {
                $(a).parents(".form-group").removeClass("has-error").addClass("has-success")
            },
            rules: {
                name: {
                    required: !0,
            ...
            messages: {
                name: {
                    ...
                    minlength: "Ops! Nome curto demais."
                },
                email: "Digite um email v&aacute;lido."
            }
        }), new LazyLoad, setTimeout(loadBlog, 2e3), window.dataLayer = window.dataLayer || [], $("#cta-header-home").click(function() {
            window.window.dataLayer.push({
                event: "click-event-home-header"
            })
        }), $("#cta-cloud-sites").click(function() {
            window.window.dataLayer.push({
                event: "click-event-cloudsites-billing"
            })
        }), $("#cta-menu-register").click(function() {
            window.window.dataLayer.push({
                event: "click-event-partial-header-menu"
            })
        }), $("#cta-prices").click(function() {
            window.window.dataLayer.push({
                event: "click-event-partial-prices"
            })
        }), $("#cta-faq").click(function() {
            window.window.dataLayer.push({
                event: "click-event-partial-faq"
            })
        })
